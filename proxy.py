...
def hexdump(src, length=16, show=True):
    """helper function to display the communication between local and remote machines"""
...
def receive_from(connection):
    """function that proxy will use to receive data from local and remote machines"""
    buffer = b""
...
def main():
    if len(sys.argv[1:]) != 5:
        ...
        print("Example: python3 proxy.py 127.0.0.1 7000 10.7.78.1 8000 True")
        sys.exit(0)
